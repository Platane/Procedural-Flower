...
var b=new Flw.Branch();
var v={x:Math.cos(d),y:Math.sin(d)};var option=Flw.buildOption(option||{});
b.init(
A,
v,
...
Flw.TwistedBranch=function(){};for(var i in Flw.Branch.prototype)
Flw.TwistedBranch.prototype[i]=Flw.Branch.prototype[i];
Flw.TwistedBranch.prototype._deepnessFromTwist=0;
Flw.TwistedBranch.prototype._deepnessMaxFromTwist=0;
...
b.init.apply(b,arguments);
return b;
};Flw.Leaf=function(){};Flw.Leaf.prototype={
_o:null,
_pic:null,
_topEar:null,
_botEar:null,
...
b.init.apply(b,arguments);
return b;
};Flw.Head=function(){};Flw.Head.prototype={
_hatchingTime:null,
_children:null,
...
b.init.apply(b,arguments);
return b;
};Flw.Petal=function(){};Flw.Petal.prototype={
_hatchingTime:null,
_radius:null,
_d:null,
_deep:null,
...
_baseRoot:null,
_growSpeed:0.2,
_scrollCalculatorTimer:null,
_scrollCalculatorInterval:null,
_scrollSpeed:null,
...
var centre=55+this._window*(0.2+this._growSpeed/3);
var py=this._vBuffer+this._canvasHeight-centre;
